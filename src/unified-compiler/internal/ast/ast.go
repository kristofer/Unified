...
const (
	...
	OperatorBitNot     OperatorType = "BitNot"     // ~ (bitwise NOT)
	...
	OperatorAnd        OperatorType = "And"        // && (logical AND)
	OperatorOr         OperatorType = "Or"         // || (logical OR)
	OperatorBitAnd     OperatorType = "BitAnd"     // & (bitwise AND)
	OperatorBitOr      OperatorType = "BitOr"      // | (bitwise OR)
	OperatorBitXor     OperatorType = "BitXor"     // ^ (bitwise XOR)
	OperatorLShift     OperatorType = "LShift"     // << (left shift)
	OperatorRShift     OperatorType = "RShift"     // >> (right shift)
...
func (n *NewExpr) Pos() Position   { return n.Position }
